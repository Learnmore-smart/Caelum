...
The Windows Notes logo and all related branding assets in this directory
...
- Modify, redistribute, or create derivative works of the logo
- Use the logo to imply endorsement or affiliation

The logo is included in this repository solely for building the official
Windows Notes application. If you fork this project, you must replace
